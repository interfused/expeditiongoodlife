...
class InterfusedPluginsTable extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        // call update server
        $response = wp_remote_get('http://updates.interfused.com/themes/' . THEME_SHORT, array( 'timeout' => 30));
    ...
    {
         _e('Error connecting to server \'http://updates.interfused.com/themes/'.THEME_SHORT.'\' :'. $this->error_description);
    }
