	...
	<div class="panel panel-primary panel-bbpress">
		...
		<div class="panel-body">
			<fieldset class="bbp-form">
				<legend><?php _e( 'User Info', 'my_theme-td' ) ?></legend>

				<?php do_action( 'bbp_user_edit_before_name' ); ?>

				<div class="form-group">
					<label for="first_name"><?php _e( 'First Name', 'my_theme-td' ) ?></label>
				...
				<div class="form-group">
					<label for="last_name"><?php _e( 'Last Name', 'my_theme-td' ) ?></label>
				...
				<div class="form-group">
					<label for="nickname"><?php _e( 'Nickname', 'my_theme-td' ); ?></label>
				...
				<div class="form-group">
					<label for="display_name"><?php _e( 'Display Name', 'my_theme-td' ) ?></label>
			...
			<fieldset class="bbp-form">
				<legend><?php _e( 'Contact Info', 'my_theme-td' ) ?></legend>

				<?php do_action( 'bbp_user_edit_before_contact' ); ?>

				<div class="form-group">
					<label for="url"><?php _e( 'Website', 'my_theme-td' ) ?></label>
			...
			<fieldset class="bbp-form">
				<legend><?php bbp_is_user_home_edit() ? _e( 'About Yourself', 'my_theme-td' ) : _e( 'About the user', 'my_theme-td' ); ?></legend>

				<?php do_action( 'bbp_user_edit_before_about' ); ?>

				<div class="form-group">
					<label for="description"><?php _e( 'Biographical Info', 'my_theme-td' ); ?></label>
			...
			<fieldset class="bbp-form">
				<legend><?php _e( 'Account', 'my_theme-td' ) ?></legend>
				...
				<div class="form-group">
					<label for="email"><?php _e( 'Email', 'my_theme-td' ); ?></label>
					...
					if ( !empty( $new_email ) && $new_email !== bbp_get_displayed_user_field( 'user_email', 'edit' ) ) : ?>
						...
						<span class="updated inline">
							...
							<?php printf( __( 'There is a pending email address change to <code>%1$s</code>. <a href="%2$s">Cancel</a>', 'my_theme-td' ), $new_email['newemail'], esc_url( self_admin_url( 'user.php?dismiss=' . bbp_get_current_user_id()  . '_new_email' ) ) ); ?>
				...
				<div id="password">
					<label for="pass1"><?php _e( 'New Password', 'my_theme-td' ); ?></label>
					<fieldset class="bbp-form password">
						<div class="form-group">
							...
							<span class="help-block"><?php _e( 'If you would like to change the password type a new one. Otherwise leave this blank.', 'my_theme-td' ); ?></span>
						</div>

						<div class="form-group">
							<input class="form-control" type="password" name="pass2" id="pass2" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
							<span class="help-block"><?php _e( 'Type your new password again.', 'my_theme-td' ); ?></span><br />
						</div>

						<div id="pass-strength-result"></div>
						<span class="help-block indicator-hint"><?php _e( 'Your password should be at least ten characters long. Use upper and lower case letters, numbers, and symbols to make it even stronger.', 'my_theme-td' ); ?></span>
					</fieldset>
				</div>
			...
			<?php if ( current_user_can( 'edit_users' ) && ! bbp_is_user_home_edit() ) : ?>
				...
				<fieldset class="bbp-form">
					<legend><?php _e( 'User Role', 'my_theme-td' ); ?></legend>
					...
					<?php if ( is_multisite() && is_super_admin() && current_user_can( 'manage_network_options' ) ) : ?>
						...
						<div class="checkbox">
							<label for="super_admin"><?php _e( 'Network Role', 'my_theme-td' ); ?></label>
							<label>
								...
								<?php _e( 'Grant this user super admin privileges for the Network.', 'my_theme-td' ); ?>
							</label>
						</div>
		...
		<div class="panel-footer">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="button submit user-submit"><?php bbp_is_user_home_edit() ? _e( 'Update Profile', 'my_theme-td' ) : _e( 'Update User', 'my_theme-td' ); ?></button>
		</div>
	</div>
</form>