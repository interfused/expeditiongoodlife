...
<div class="wp-pinterest-automatic-container">
      ...
      <div id="field-pin_text-container" class="field f_100">
      	...
      	<input  class="widefat"  value="<?php echo stripslashes( $pin_text ) ;  ?>" name="pin_text" id="field-pin_text" required="required" type="text">
      ...
      <?php if(stristr($pin_options, 'OPT_FRONT')){?>
      	<iframe style="display: none" id="wp_pinterest_automatic_ifr" src="<?php echo site_url('?wp_pinterest_automatic=show_post&pid='.$post->ID.'&post_type='.$post->post_type) ?>"></iframe>
      <?php } ?>
