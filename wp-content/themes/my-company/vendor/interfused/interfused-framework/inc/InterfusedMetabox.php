...
class InterfusedMetabox
{
    ...
    public function admin_enqueue_scripts()
    {
        ...
        if (isset($screen) && 'post' == $screen->base &&  isset($this->options['pages']) &&  in_array($screen->post_type, $this->options['pages']) || isset($screen) && 'edit-tags' == $screen->base && isset($this->options['taxonomies']) &&  in_array($screen->taxonomy, $this->options['taxonomies'])) {
            ...
            wp_enqueue_style('pm-metabox-global', PM_TF_URI . 'assets/css/metaboxes/metabox-global.css', array('jquery-interfused-ui-theme'));
            wp_enqueue_script('metabox-options-global', PM_TF_URI . 'assets/javascripts/metabox-options-global.js', array('jquery', 'jquery-ui-tooltip'));
