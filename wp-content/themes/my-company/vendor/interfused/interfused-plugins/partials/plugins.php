    ...
    <div class="white-box">
        ...
        <div class="left-part half">
            ...
            <form class="big-form" action="<?php echo $form_url ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="purchase-code" name="purchase-code" placeholder="<?php _e('Enter the themes purchase code', 'my_theme-admin-td'); ?>" value="<?php echo isset($plugin_options['purchase-code']) ? $plugin_options['purchase-code'] : ''; ?>">
                </div>
        ...
        <div class="right-part half text-center">
            <a class="youtube" href="http://youtu.be/G6CX5TycBpg" target="_blank">
                ...
                <?php _e('Click to watch how to install plugins.', 'my_theme-admin-td'); ?>
            </a>

        </div>
    </div>
    <h3><?php _e('Plugins Installer', 'my_theme-admin-td') ?></h3>
