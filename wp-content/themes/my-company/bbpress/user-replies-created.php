...
?>
	...
	<div id="bbp-user-replies-created" class="bbp-user-replies-created panel panel-primary panel-bbpress">
		<div class="panel-heading">
			<?php _e( 'Forum Replies Created', 'my_theme-td' ); ?></h2>
		</div>
		...
		<div class="bbp-user-section panel-body">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You have not replied to any topics.', 'my_theme-td' ) : _e( 'This user has not replied to any topics.', 'my_theme-td' ); ?></p>
