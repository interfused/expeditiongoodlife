 ...
 (function($) {
    ...
    $(document).ready(function($) {
        $('#typekit-kits-button').click( function() {
            ...
            $updateListButton.after( '<span id="updateListMessage"><img src="../../../../../interfused/interfused-typography/assets/javascripts/options/images/wpspin_light.gif" style="vertical-align:middle;padding: 0px 5px;" /><span>Fetching...</span></div>' );
