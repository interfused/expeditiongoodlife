<div class="pm-one-click pm-one-click-remove-content wrap">
    ...
    <?php endif ?>
    <p>All done!  You can go ahead and <a href="../../../interfused/interfused-one-click/partials/admin.php?page=<?php echo THEME_SHORT; ?>-oneclick">install another demo content now!</a></p>
</div>