<div class="col-md-12">
    <header class="blog-header small-screen-center <?php echo implode( ' ', $header_classes ); ?>" data-os-animation="<?php echo $scroll_animation; ?>" data-os-animation-delay="<?php echo $scroll_animation_delay; ?>s" <?php echo implode(' ', $parallax_data_attr); ?>>
        ...
        <?php if ( !is_home() && pm_get_option('blog_header_show_breadcrumbs') === 'show' ) :  ?>
            <ol class="breadcrumb breadcrumb-blog <?php echo pm_get_option('blog_header_breadcrumbs_case'); ?>">
                <li>
                    <a href="<?php echo home_url(); ?>"><?php echo __( 'home', 'my_theme-td' ); ?></a>
                </li>
                <?php if(!is_search()): ?>
                    <li>
                        <a href="<?php
                            if( get_option( 'show_on_front' ) == 'page' ) :
                                ...
                                echo home_url();
                            endif; ?>"><?php echo __( 'blog', 'my_theme-td' ); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if (is_category()) : ?>
                ...
                <?php endif; ?>
                 <?php if( is_search() ) : ?>
                    <li>
                        <?php echo __('Results for ', 'my_theme-td'). get_search_query();  ?>
                    </li>
                <?php endif; ?>
                </ol>
        <?php endif; ?>
