<div class="pm-one-click pm-one-click-remove wrap">
    ...
    <form id="remove-content-form" method="post" action="../../../interfused/interfused-one-click/partials/admin.php?page=<?php echo THEME_SHORT; ?>-oneclick">
