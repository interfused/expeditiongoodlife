...
if(class_exists('WP_Customize_Control')) {
    class pm_Customize_Slider_Control extends WP_Customize_Control
    {
        public $type = 'slider';
        ...
        {
            include PM_TF_DIR . 'partials/customise/slider.php';
        }
    }
}

class InterfusedCustomise
{
            ...
            foreach ($section['fields'] as $index => $field) {
                ...
                switch ($field['type']) {
                    ...
                    case 'slider':
                        ...
                        $wp_customize->add_control(new pm_Customize_Slider_Control($wp_customize, $control_id, $control_args));
                        break;
