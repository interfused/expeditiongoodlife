...
function bulmapress_copyright_link($author = 'Interfused', $url = 'http://interfused-inc.com')
{
	$output = '
		<p class="copyright-link">&copy; '. date('Y') . ' ArchiDesign and Build. All rights reserved.<br>
			site by <a href=" ' . $url . '">' . $author . '</a>
		</p>';
	echo $output;
}
