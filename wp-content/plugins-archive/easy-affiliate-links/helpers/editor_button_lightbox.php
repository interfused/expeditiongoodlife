    ...
    <div id="eafl_tab_select">
        <table id="eafl_select_link">
            ...
            <tr>
                ...
                <th scope="col"><?php _e( 'Link Text', 'easy-affiliate-links' ); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            <tr>
	            ...
	            <td>
		            <select class="eafl_use_link" data-id="<?php echo $link['ID']; ?>" data-name="<?php echo esc_attr( $link['name'] ); ?>">
                        <?php if( isset( $_GET['eafl_selection'] ) && trim( $_GET['eafl_selection'] ) !== '' ) { ?>
                            <option value="<?php echo esc_attr( $_GET['eafl_selection'] ); ?>"><?php echo $_GET['eafl_selection']; ?></option>
                        <?php }?>
                        <?php
                ...
                <td>
                    <input type="button" class="button button-primary eafl_add_link" value="Add">
                </td>
            </tr>
            <?php } ?>
            </tbody>
