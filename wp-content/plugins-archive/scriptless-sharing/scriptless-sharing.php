<?php
/*
Plugin Name: Scriptless Sharing
 ...
 */
 ...
 if(!is_admin())
{
	new Scriptless_Sharrre_plugin();
}

class Scriptless_Sharrre_plugin
{
...
*/
	...
	{
		wp_enqueue_style( 'scriptless-share-button-style', plugins_url( 'css/styling.css', __FILE__ ) );
	}
/*
...
function scriptless_share_fn($atts){
    ...
    $share = new Scriptless_Sharrre_plugin();
