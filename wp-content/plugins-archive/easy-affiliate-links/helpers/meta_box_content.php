...
<table class="eafl_form">
    ...
    <tr class="eafl_divider eafl_description_input">
        <td><label for="eafl_description"><?php _e( 'Description', 'easy-affiliate-links' ); ?></label></td>
        <td><textarea name="eafl_description" id="eafl_description" rows="2"><?php echo $link->description(); ?></textarea></td>
        <td><?php _e( 'Use this to store any link specific information.', 'easy-affiliate-links' ); ?> <?php _e( 'Not public.', 'easy-affiliate-links' ); ?></td>
    </tr>
	<?php
