...
<div class="container-fullwidth">
    <div class="row">
        <div class="col-md-12">
            <div class="masonry blog-masonry use-masonry isotope no-transition" data-padding="<?php echo pm_get_option('blog_masonry_item_padding'); ?>" data-col-xs="1" data-col-sm="2" data-col-md="4" data-col-lg="6">
