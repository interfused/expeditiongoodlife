 ...
 */
class InterfusedImgradio extends InterfusedOption
{
    /**
     * Creates option
     *
    ...
    public function enqueue()
    {
        ...
        // load scripts
        wp_enqueue_script('imgradio-field', PM_TF_URI . 'inc/options/fields/imgradio/imgradio.js', array('jquery-ui-button'));
    }
}
