<div class="pm-one-click pm-one-click-install wrap" data-install-id="<?php echo $current_package['id']; ?>">
    <h2>Installing Demo Content Package</h2>

    <div class="package-panel">
        <div class="screenshot">
            <img src="<?php echo $current_package['../../../interfused/interfused-one-click/partials/thumbnail']; ?>" alt="<?php echo $current_package['name'] ?>" onmouseover="rollImage(this, true)" onmouseleave="rollImage(this, false)">
        </div>
...
<form id="import-finished-form" method="post" action="../../../interfused/interfused-one-click/partials/admin.php?page=<?php echo THEME_SHORT; ?>-oneclick">
