...
function custom_admin_post_thumbnail_html( $content ) {
    return $content = str_replace( __( 'Set featured image', 'ebor_starter' ), __( 'Set featured image (Min 640px Width)', 'ebor_starter' ), $content);
}
...
function ebor_excerpt_more( $more ) {
	return ' <a href="'. get_permalink() .'">' . get_option('blog_continue', 'Continue Reading &rarr;') . '</a>';
}
