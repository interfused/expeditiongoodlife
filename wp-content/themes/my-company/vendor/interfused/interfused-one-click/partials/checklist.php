<div class="pm-one-click pm-one-click-checklist wrap">
    <h2><?php echo $current_package['name']; ?> - <?php _e('Pre Install Checklist', 'my_theme-admin-td'); ?></h2>
    <div id="ajax-errors-here"></div>

    <p><?php _e('Before we install the demo content onto your WordPress, we just have a few checks to run to make sure you are all set.', 'my_theme-admin-td'); ?></p>

    <table class="widefat importers preflight" style="width:100%;">
        <thead>
            <tr>
                <th scope="row"><?php _e('Result', 'my_theme-admin-td'); ?></th>
                <th scope="row"><?php _e('Check', 'my_theme-admin-td'); ?></th>
                <th scope="row"><?php _e('Value', 'my_theme-admin-td'); ?></th>
                <th scope="row"><?php _e('Information', 'my_theme-admin-td'); ?></th>
            </tr>
        </thead>
        <tbody>
    ...
    <footer>
        ...
        <?php if ($check_list_ok): ?>
            <form id="install-form" method="post" action="../../../interfused/interfused-one-click/partials/admin.php?page=<?php echo THEME_SHORT; ?>-oneclick">
