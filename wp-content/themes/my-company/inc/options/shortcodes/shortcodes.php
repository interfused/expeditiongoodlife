...
function pm_shortcode_section( $atts , $content = '') {
    ...
    $has_video = ( !empty( $background_video_mp4 ) || !empty( $background_video_webm ) ) && ( !$pm_is_iphone && !$pm_is_ipad  && !$pm_is_android || pm_get_option( 'mobile_videos' ) === 'on' );
    $has_media = !empty( $background_image ) || $has_video || ( !empty( $background_image_mobile ) && ( $pm_is_iphone || $pm_is_ipad  || $pm_is_android ) );
    ...
    if( is_numeric( $background_image_mobile ) && ( $pm_is_iphone || $pm_is_ipad  || $pm_is_android ) ){
    ...
    if( 'on' === $background_image_parallax ) {
        $offset_y = 0;
        if( 'navbar-sticky' === pm_get_option( 'header_type' ) ) {
            $offset_y = pm_get_option('navbar_scrolled');
        }
    ...
    $overlay_colour = pm_hex2rgba( $overlay_colour, $overlay_opacity );
...
add_shortcode( 'vc_row', 'pm_shortcode_section' );
 ...
 **/
function pm_section_heading( $options, $content = '' ) {
    extract( shortcode_atts( array(
        'sub_header'            => '',
        'header_type'           => 'h1',
    ...
    if ( 'on' === $header_fade_out ) {
        $fade_y = 0;
        if( 'navbar-sticky' === pm_get_option( 'header_type' ) ) {
            $fade_y = pm_get_option('navbar_scrolled');
        }
...
add_shortcode( 'heading', 'pm_section_heading' );
 ...
 * @return shortcode HTML
 **/
function pm_section_vc_row_inner( $atts, $content ) {
    extract( shortcode_atts( array(
        'extra_classes' => ''
    ), $atts ) );
...
add_shortcode( 'vc_row_inner', 'pm_section_vc_row_inner' );
 ...
 * @return shortcode HTML
 **/
function pm_section_vc_column( $atts, $content ) {
    extract( shortcode_atts( array(
        'width'                  => '1/1',
        'column_colour'          => '',
        'extra_classes'          => '',
...
add_shortcode( 'vc_column', 'pm_section_vc_column' );
add_shortcode( 'vc_column_inner', 'pm_section_vc_column' );
 ...
 * @return shortcode HTML
 **/
function pm_section_vc_column_text( $atts, $content ) {
    extract( shortcode_atts( array(
        'extra_classes'          => '',
        'margin_top'             => 'short-top',
        'margin_bottom'          => 'short-bottom',
...
add_shortcode( 'vc_column_text', 'pm_section_vc_column_text' );
 ...
 * @return <hr> HTML
 **/
function pm_section_vc_separator( $atts, $content ) {
    return '<hr>';
}
add_shortcode( 'vc_separator', 'pm_section_vc_separator' );
 ...
 * @return shortcode HTML
 **/
function pm_section_vc_single_image($atts , $content = '') {
    // setup options
    extract( shortcode_atts( array(
        'image'                    => '',
        'size'                     => 'medium',
...
add_shortcode( 'vc_single_image', 'pm_section_vc_single_image' );
 ...
 * @return shortcode HTML
 **/
function pm_section_shapedimage($atts , $content = '') {
    // setup options
    extract( shortcode_atts( array(
        'image'             => '',
        'shape_size'        => 'medium',
...
add_shortcode( 'shapedimage', 'pm_section_shapedimage' );
 ...
 * @return shortcode HTML
 **/
function pm_shortcode_vc_tabs($atts , $content = '' ) {
    extract( shortcode_atts( array(
        'style'        => 'top',
        // global options
        'extra_classes'          => '',
...
add_shortcode( 'vc_tabs', 'pm_shortcode_vc_tabs' );
 ...
 * @return shortcode HTML
 **/
function pm_shortcode_vc_tab($atts , $content=''){

    return do_shortcode($content);
}
add_shortcode( 'vc_tab' , 'pm_shortcode_vc_tab');

function pm_shortcode_vc_accordion($atts , $content = '' ) {
    extract( shortcode_atts( array(
        'type' => 'primary',
        // global options
        'extra_classes'          => '',
...
add_shortcode( 'vc_accordion', 'pm_shortcode_vc_accordion' );
 ...
 * @return shortcode HTML
 **/
function pm_shortcode_vc_accordion_tab($atts , $content=''){

    return do_shortcode($content);
}
add_shortcode( 'vc_accordion_tab' , 'pm_shortcode_vc_accordion_tab');
 ...
 * @return Code html
 **/
function pm_shortcode_code( $atts, $content = null) {
    extract( shortcode_atts( array(
        // global options
        'extra_classes'          => '',
        'margin_top'             => 'short-top',
...
add_shortcode( 'code', 'pm_shortcode_code' );
 ...
 * @return Icon html
 **/
function pm_shortcode_icon( $atts, $content = null) {
    extract( shortcode_atts( array(
        'size'       => '16',
    ), $atts ) );
...
add_shortcode( 'icon', 'pm_shortcode_icon' );
 ...
 **/
function pm_shortcode_lead( $atts, $content ) {
    extract( shortcode_atts( array(
        'align'  => 'center',
        // global options
        'extra_classes'          => '',
...
add_shortcode( 'lead', 'pm_shortcode_lead' );
 ...
 **/
function pm_shortcode_blockquote( $atts, $content ) {
    extract( shortcode_atts( array(
        'who'   => '',
        'cite'  => '',
        'align'  => 'left',
...
add_shortcode( 'blockquote', 'pm_shortcode_blockquote' );
 ...
 * @return Feature List
 **/
function pm_shortcode_features_list( $atts, $content = null) {
    extract( shortcode_atts( array(
...
add_shortcode( 'features_list', 'pm_shortcode_features_list' );
 ...
 * @return Feature Item
 **/
function pm_shortcode_feature( $atts, $content = null) {
    extract( shortcode_atts( array(
        'show_icon'              => 'show',
        'fa_icon'                => '',
        'svg_icon'               => '',
...
add_shortcode( 'feature', 'pm_shortcode_feature' );
 ...
 * @return Icon html
 **/
function pm_shortcode_featuredicon( $atts, $content = null) {
    // setup options
    extract( shortcode_atts( array(
        'icon'              => 'headphones',
        'shape_size'        => 'medium',
...
add_shortcode( 'featuredicon', 'pm_shortcode_featuredicon' );
 ...
 * @return Icon html
 **/
function pm_shortcode_svgicon( $atts, $content = null) {
    // setup options
    extract( shortcode_atts( array(
        'icon'              => 'link',
        'shape_size'        => 'medium',
...
add_shortcode( 'svgfeaturedicon', 'pm_shortcode_svgicon' );
/**
 * Creates a bootstrap button
 *
 * @return bootstrap button HTML
 **/
function pm_shortcode_button($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'type'          => 'default',
        'animation'     => '',
...
add_shortcode( 'button', 'pm_shortcode_button' );


/* Services Section */
function pm_shortcode_service( $atts, $content = '') {
    extract( shortcode_atts( array(
        'service'           => '',
        'image_shape'       => 'round',
        'image_size'        => 'big',
...
add_shortcode( 'service', 'pm_shortcode_service' );


/* Services Section */
function pm_shortcode_services( $atts, $content = '') {
    extract( shortcode_atts( array(
        'category'          => '',
        'count'             => '3',
        'columns'           => '3',
...
add_shortcode( 'services', 'pm_shortcode_services' );
 ...
 * @since 1.2
 */
function pm_gallery_shortcode($attr) {
    $post = get_post();
...
add_shortcode( 'gallery', 'pm_gallery_shortcode' );

/* ---------- TESTIMONIALS SHORTCODE ---------- */

function pm_shortcode_testimonials( $atts , $content = '' ) {
    // setup options
    extract( shortcode_atts( array(
        'count'       => '3',
        'group'       => '',
...
add_shortcode( 'testimonials', 'pm_shortcode_testimonials' );

/* ---------- TESTIMONIALS LIST SHORTCODE ---------- */

function pm_shortcode_testimonials_list( $atts , $content = '' ) {
    // setup options
    extract( shortcode_atts( array(
        'count'       => '3',
        'columns'     => '3',
...
add_shortcode( 'testimonials_list', 'pm_shortcode_testimonials_list' );

/* Staff List */
function pm_shortcode_staff_list($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'department'                   => '',
        'count'                        => '3',
...
add_shortcode( 'staff_list', 'pm_shortcode_staff_list' );



/* ---------------- FEATURED STAFF MEMBER SHORTCODE --------------- */

function pm_shortcode_staff_featured($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'member'                    => '',
        'show_position'             => 'show',
...
add_shortcode( 'staff_featured', 'pm_shortcode_staff_featured' );

/* --------------------- PORTFOLIO SHORTCODES --------------------- */

function pm_shortcode_portfolio( $atts , $content = '', $code ) {
     // setup options
    extract( shortcode_atts( array(
        'categories'             => '',
        'count'                  => '0',
    ...
    global $paged, $pm_is_iphone, $pm_is_ipad, $pm_is_android;
    ...
    $filters = get_terms( 'pm_portfolio_categories', array( 'hide_empty' => 1 ) );
...
add_shortcode( 'portfolio', 'pm_shortcode_portfolio' );

function pm_shortcode_portfolio_masonry( $atts , $content = '', $code ) {
     // setup options
    extract( shortcode_atts( array(
        'categories'             => '',
        'count'                  => '0',
...
add_shortcode( 'portfolio_masonry', 'pm_shortcode_portfolio_masonry' );


/* ---------------------- PIE CHART SHORTCODE -----------------  */

function pm_shortcode_pie( $atts , $content = '' ){
    // setup options
    extract( shortcode_atts( array(
        'track_colour'  => '',
        'bar_colour'    => '',
...
add_shortcode( 'pie', 'pm_shortcode_pie' );
/* ---------------------- CIRCULAR COUNTER SHORTCODE -----------------  */

function pm_shortcode_counter( $atts , $content = '' ){
    // setup options
    extract( shortcode_atts( array(
        'initvalue'      => '0',
        'value'          => 0,
...
add_shortcode( 'counter', 'pm_shortcode_counter' );

/* ---------------------- COUNTDOWN TIMER SHORTCODE -----------------  */

function pm_shortcode_countdown( $atts , $content = '' ){
    // setup options
    extract( shortcode_atts( array(
        'date'             => '',
        'number_size'      => 'super',
...
add_shortcode( 'countdown', 'pm_shortcode_countdown' );


/* --------------------- PRICING SHORTCODE ---------------------- */

function pm_shortcode_pricing($atts , $content=''){
    extract( shortcode_atts( array(
        'heading'         => '',
        'featured'        => 'false',
...
add_shortcode( 'pricing' , 'pm_shortcode_pricing');

/*----------------- RECENT NEWS SECTION SHORTCODE AND HELPER FUNCTIONS --------------------*/

function pm_get_recent_posts( $count, $categories, $authors = null , $post_formats = null ) {
    $query = array();
    // set post count
    global $paged;
    if ( get_query_var('paged') ) {
...
function pm_shortcode_recent($atts , $content = '' ) {
    // setup options
    extract( shortcode_atts( array(
        'count'                     => '3',
        'cat'                       => null,
    ...
    $posts = pm_get_recent_posts( $count, $cat );
...
add_shortcode( 'recent_posts', 'pm_shortcode_recent' );


function pm_shortcode_recent_simple($atts , $content = '' ) {
    // setup options
    extract( shortcode_atts( array(
        'count'                     => '3',
        'cat'                       => null,
...
add_shortcode( 'recent_posts_simple', 'pm_shortcode_recent_simple' );


/*------------------------ SLIDESHOW SHORTCODE -----------------------*/

function pm_shortcode_slideshow($atts , $content = '' ){
    extract( shortcode_atts( array(
        'flexslider'         => '',
        'ids'                => '',
        'animation'          => 'slide',
    ...
    if (is_array($ids)) {
        ...
        if( ( $flexslider !== '') ) {
            $query_options['tax_query'] = array(
                array(
                    'taxonomy' => 'pm_slideshow_categories',
                    'field' => 'slug',
                    'terms' => $flexslider
                )
            );
...
add_shortcode( 'slideshow', 'pm_shortcode_slideshow');

function pm_shortcode_carousel($atts , $content = '' ){
    extract( shortcode_atts( array(
        'carousel'         => '',
        'count'              => 0,
        'showcontrols'       => 'show',
...
add_shortcode( 'carousel', 'pm_shortcode_carousel');
 ...
 * @return Icon Item HTML
 **/
function pm_shortcode_social_icon( $atts, $content = null) {
    extract( shortcode_atts( array(
        'url'       => '',
        'icon'      => '',
        'target'    => '_blank',
    ...
    $output = '<li>';
    $output .= '<a data-iconcolor="'.pm_get_icon_color( $icon ).'" href="'.$url.'" '.$target.'>';
    $output .= '<i class="' . $icon . '"></i></a></li>';
    return $output;
}
add_shortcode( 'socialicon', 'pm_shortcode_social_icon' );
 ...
 * @return Map HTML
 **/
function pm_shortcode_google_map( $atts, $content = null) {
    ...
    $atts['markerURL'] = PM_THEME_URI . 'assets/images/marker.png';


    $map_id = 'map' . rand(1, 1000);

    wp_enqueue_script( THEME_SHORT.'-google-map-api', 'https://maps.googleapis.com/maps/api/js?sensor=false' );
    wp_enqueue_script( THEME_SHORT.'-google-map', PM_THEME_URI . 'assets/js/map.min.js', array( 'jquery', THEME_SHORT.'-google-map-api' ) );
...
add_shortcode( 'map', 'pm_shortcode_google_map' );



/* ---- BOOTSTRAP ALERT SHORTCODE ----- */

function pm_shortcode_alert($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'color'       => 'success',
        'title'       => 'Watch Out!',
...
add_shortcode( 'vc_message', 'pm_shortcode_alert' );

/* ---- BOOTSTRAP JUMBOTRON SHORTCODE ----- */

function pm_shortcode_jumbotron($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'title'       => 'Watch Out!',
        // global options
...
add_shortcode( 'vc_jumbotron', 'pm_shortcode_jumbotron' );
 ...
 * @return Panel html
 **/
function pm_shortcode_panel($atts , $content = '' ) {
    extract( shortcode_atts( array(
        'title'        => '',
        'style'        => '',
        // global options
...
add_shortcode( 'panel' , 'pm_shortcode_panel');


/* ------------------ PROGRESS BAR SHORTCODE -------------------- */

function pm_shortcode_progress_bar($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'percentage'    =>  '50',
        'type'          => 'progress',
...
add_shortcode( 'progress', 'pm_shortcode_progress_bar' );
 ...
 * @author
 **/
function pm_shortcode_video( $atts , $content = '' ) {
    extract( shortcode_atts( array(
        'src'    =>  '',
...
add_shortcode( 'vc_video', 'pm_shortcode_video' );


/* ---- SCROLL TO BUTTON ----- */

function pm_shortcode_scroll_to($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'link'       => '#link',
        'icon'       => 'down',
...
add_shortcode( 'vc_scroll', 'pm_shortcode_scroll_to' );

/* ---- TAG LIST SHORTCODE ----- */

function pm_shortcode_tag_list($atts , $content = '' ) {
     // setup options
    extract( shortcode_atts( array(
        'tags'    =>  '',
        'size'    => 'normal',
...
add_shortcode( 'tags', 'pm_shortcode_tag_list' );
 ...
 * @author
 **/
function pm_shortcode_sharing($atts, $content = '') {
    extract( shortcode_atts( array(
        'title'             => '',
...
add_shortcode( 'sharing', 'pm_shortcode_sharing' );
 ...
 * @author
 **/
function pm_shortcode_divider($atts, $content = '') {
    extract( shortcode_atts( array(
        'visibility' => 'hidden',
...
add_shortcode( 'divider', 'pm_shortcode_divider' );
 ...
 * @author
 **/
function pm_shortcode_social($atts, $content = '') {
    extract( shortcode_atts( array(
        'title'             => '',
        'icon_size'         => 'sm',
        'background_show'   => 'background',
...
add_shortcode( 'socialicons', 'pm_shortcode_social' );
 ...
 * @author
 **/
function pm_shortcode_chart( $atts, $content = '' ) {
    $atts = shortcode_atts( array(
        'type'                   => 'pie',
        'data'                   => '',
        'datasets'               => '',
...
add_shortcode( 'chart', 'pm_shortcode_chart' );
 ...
 * @author
 **/
function pm_shortcode_menu( $atts, $content = '' ) {
    extract( shortcode_atts( array(
        'slug'                   => '',
...
add_shortcode( 'menu', 'pm_shortcode_menu' );
 ...
 **/
function pm_shortcode_simple_icon_list( $atts, $content = null) {
    extract( shortcode_atts( array(
        'size'                   => 'normal',
        // global options
        'extra_classes'          => '',
...
add_shortcode( 'simple_icon_list', 'pm_shortcode_simple_icon_list' );
 ...
 * @return Simple Icon
 **/
function pm_shortcode_simple_icon( $atts, $content = null) {
    extract( shortcode_atts( array(
        'fa_icon'                => '',
        'icon_color'             => '#ffffff',
        'title'                  => '',
...
add_shortcode( 'simple_icon', 'pm_shortcode_simple_icon' );
 ...
 * @return Simple Icon
 **/
function pm_shortcode_audio( $atts, $content = null) {
    $atts = shortcode_atts( array(
        'src'      => '',
        'loop'     => 'off',
        'autoplay' => 'off',
...
add_shortcode( 'audio', 'pm_shortcode_audio' );
 ...
 * @return Simple Icon
 **/
function pm_shortcode_layerslider_vc( $atts, $content = null) {
    extract( shortcode_atts( array(
        'id'       => '',
        'slug'     => '',
        'el_class' => ''
...
add_shortcode( 'layerslider_vc', 'pm_shortcode_layerslider_vc' );
 ...
 * @return List of SVGs
 **/
function pm_shortcode_svg( $atts, $content = null) {
    $svg_array = include PM_THEME_DIR . 'inc/options/global-options/svgs.php';
...
add_shortcode( 'svg_vc', 'pm_shortcode_svg' );