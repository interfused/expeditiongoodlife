(function($){
    ...
    $.fn.htmlMenu = function(){
        function fetchData( $this ) {
            ...
            $.getJSON( ajaxurl + '?action=pm_shortcodes_menu', function( data ) {
                    ...
                    if( item.shortcode !== undefined ) {
                        switch( item.insert_with ) {
                            case 'dialog':
                                ...
                                menuCode += '<li><a href="../../../../../interfused/interfused-framework/assets/javascripts/shortcodes/' + createDialogURL( item ) + '" class="thickbox thickbox-preview" title="' + item.title + '">' + item.title + '</a></li>';
                            break;
                            case 'insert':
                                // just insert code
        ...
        function createDialogURL( item ) {
            ...
            var params = [];
            params.push( 'action=pm_shortcodes' );
