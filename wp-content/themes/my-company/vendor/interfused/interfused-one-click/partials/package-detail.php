 ...
 */
?>
<div class="pm-one-click-package-popup">
    <?php if ($current_package !== null): ?>
        <div class="package-about">
            <div class="package-screenshots">
                <div class="screenshot">
                    <img src="<?php echo $current_package['../../../interfused/interfused-one-click/partials/screenshot']; ?>" alt="<?php echo $current_package['name'] ?>" onmouseover="rollImage(this, true)" onmouseleave="rollImage(this, false)">
                </div>
            </div>
            ...
            <div class="package-actions">
                <?php if ($package_install_ok): ?>
                    <form method="post" action="../../../interfused/interfused-one-click/partials/admin.php?page=<?php echo THEME_SHORT; ?>-oneclick">
                ...
                <a class="button button-secondary" href="<?php echo $current_package['../../../interfused/interfused-one-click/partials/demo_url']; ?>" target="_blank">View Demo</a>
                <a class="button button-secondary" href="<?php echo $installer_details['../../../interfused/interfused-one-click/partials/install_plugins_url']; ?>">Install Plugins</a>
            </div>
        </div>
    <?php else: ?>
