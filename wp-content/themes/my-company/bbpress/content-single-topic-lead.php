...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>-lead" class="bbp-lead-topic">
	...
	<li class="bbp-header">
		...
		<div class="bbp-topic-author"><?php  _e( 'Creator',  'my_theme-td' ); ?></div><!-- .bbp-topic-author -->

		<div class="bbp-topic-content">

			<?php _e( 'Topic', 'my_theme-td' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-topic-author"><?php  _e( 'Creator',  'my_theme-td' ); ?></div>
